...
<div align="center">
  ...
  <h1><b>Fullstack - Rails Backend</b></h1>
...
- [📖 Fullstack - Rails Backend ](#-fullstack---rails-backend-)
...
**Fullstack - Rails Backend** is a backend project for fullstack app rent a car apps
...
```bash
  git clone https://github.com/ichsansandy/rails-two-apps.git
```

You need to setup database for these project

```
  development = hello_world_dev
  test        = hello_world_test
  production  = hello_world_prod
```
